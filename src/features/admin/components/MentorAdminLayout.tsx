...
const MentorAdminLayout = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: 'create',
      path: '/mentor/create',
      description: 'Create new learning materials'
    },
    {
  ...
  const getIcon = (iconName: string) => {
    const iconComponents: { [key: string]: JSX.Element } = {
      ...
      create: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>,
          ...
          <div className="px-6 py-4 flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-semibold text-gray-800">
                {menuItems.find(item => isActive(item.path))?.title || 'Mentor Admin Dashboard'}
              </h2>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-gray-700">Mentor Admin</span>
              </div>
            </div>
          </div>
        </header>
